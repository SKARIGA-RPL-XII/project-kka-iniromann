    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="flex-1 flex flex-col lg:ml-64">
            <header class="bg-white border-b border-gray-200 sticky top-0 z-40">
                <div class="flex items-center justify-between h-16 px-6">
                    ...
                    <h1 class="text-xl font-semibold text-gray-900">Tambah Pengajuan Surat</h1>
                    <div class="text-sm text-gray-600">{{ now()->format('d M Y, H:i') }} WIB</div>
                </div>
            </header>
        ...
        <div class="bg-gradient-to-r from-primary to-secondary rounded-xl shadow-lg p-6 mb-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold mb-2">Tambah Pengajuan Surat</h2>
                    <p class="text-green-100">Buat pengajuan surat baru untuk penduduk</p>
                </div>
        ...
        <form method="POST" action="{{ route('admin.pengajuan.store') }}" enctype="multipart/form-data">
                ...
                <!-- File Surat Section -->
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-6" id="file-surat-section" style="display: none;">
                    <div class="flex items-center mb-6">
